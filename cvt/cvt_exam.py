...
class Tester:
    ...
    def parse_lib(self):
        ...
        with open(self.lib_path,'rb') as f:
            ...
            for i in range(char_cnt):
                ...
                word_width,word_height,word_x_offset,word_y_offset,word_actual_width,word_byte_len=struct.unpack('<BBBBBH',font_bin[word_offset:(word_offset+7)])
                word_ba=font_bin[(word_offset+7):(word_offset+7+word_byte_len)]
                
                print("%s,%d,%d,%d,%d,%d,%d"%(word,word_width,word_height,word_x_offset,word_y_offset,word_actual_width,word_byte_len))
                self.char_list.append(word)
                self.char_bin_map[word]=(word_width,word_height,word_x_offset,word_y_offset,word_actual_width,word_ba)
    ...
    def update_screen(self):
        ...
        word_width,word_height,word_x_offset,word_y_offset,word_actual_width,word_ba=self.char_bin_map[word]
